...
### The Data
This project fetches and processes content locally from the [Old School RuneScape Wiki](https://oldschool.runescape.wiki/). Content on the OSRS Wiki is licensed under **[CC BY-NC-SA 3.0](https://creativecommons.org/licenses/by-nc-sa/3.0/)**.
